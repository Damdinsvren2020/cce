...
export default function RegularForms() {
  ...
  const postFeedback = (files) => {
    console.log(files);
    const url = "http://103.119.92.91:3050/feedBackFromBenefWeb/postall";
  ...
  const configHanlde = () => {
    postFeedback(feedBackState.files);
  };
            ...
            <form>
              <div>
                ...
                <span style={{ fontStyle: "italic" }}>
                  ...
                  тус бүр "Feedback" хуудсанд орох болно
                </span>
              </div>
            </form>
          </CardBody>
